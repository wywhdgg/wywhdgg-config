...
public class ProjectController {
	...
	public String index(Model model) {
		...
		List<ConfProject> list = xxlConfProjectDao.findAll();
	...
	public Result<String> save(ConfProject xxlConfProject){
		...
		// valid repeat
		ConfProject existProject = xxlConfProjectDao.load(xxlConfProject.getAppname());
	...
	public Result<String> remove(String appname){
		...
		List<ConfProject> allList = xxlConfProjectDao.findAll();
		if (allList.size() == 1) {
